...
(function () {
  ...
  function translateDOM(lang) {
    ...
    document.querySelectorAll("[data-rss-base]").forEach(function (el) {
      el.href = el.getAttribute("data-rss-base") + (lang === "en" ? "" : "/" + lang) + "/index.xml";
    });
  ...
  function fetchAndRenderFeed(mount, lang) {
    ...
    var rssUrl = mount.getAttribute("data-rss-" + lang) || (base + (lang === "en" ? "" : "/" + lang) + "/index.xml");
